...
function renderMoodChart(moodData) {
    ...
    moodChart = new Chart(ctx, {
      ...
      // In the renderMoodChart function, update the options:
options: {
    responsive: true,
    ...
    scales: {
        y: {
            ...
            title: {
                display: true,
                text: 'Mood Level',
                color: '#FDBB30', // Gold color for title
                font: {
                    size: 14,
                    weight: 'bold'
                }
    ...
    plugins: {
        ...
        tooltip: {
            backgroundColor: 'rgba(0, 45, 98, 0.9)', // Dark blue background
            titleColor: '#FDBB30', // Gold title
...
function renderFactorsChart(factorsData) {
    ...
    factorsChart = new Chart(ctx, {
        ...
        // In the renderFactorsChart function, update the options:
options: {
    responsive: true,
    maintainAspectRatio: false,
    scales: {
